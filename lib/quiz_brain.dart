...
class QuizBrain{
  ...
  int getQuizListLength(){
    return _quizList.length;
  }

  String getQuestionText(){
    return _quizList[_questionNumber].questionText;
  }

  bool getQuestionAnswer(){
    return _quizList[_questionNumber].questionAnswer;
  }

  bool isFinished() {
    if (_questionNumber >= getQuizListLength() - 1) {
